  ...
  return (
    <section className="w-[80%] mx-auto py-20 bg-white">
      <div className="text-center">
        {/* Small Title */}
        <h2 className="font-semibold text-ttext mb-4">Services</h2>
        ...
        {/* Description */}
        <p className="text-lg text-ptext mb-10 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className=" p-6 rounded-lg shadow-lg text-center">
            ...
            <h4 className="text-xl font-semibold  text-ttext mb-2">Analytics</h4>
          ...
          <div className=" p-6 rounded-lg shadow-lg text-center">
            ...
            <h4 className="text-xl font-semibold  text-ttext mb-2">User Growth</h4>
            <p className="text-gray-600 mb-4">
          ...
          <div className="p-6 rounded-lg shadow-lg text-center">
            ...
            <h4 className="text-xl font-semibold  text-ttext mb-2">Cloud Integration</h4>
            <p className="text-gray-600 mb-4">
